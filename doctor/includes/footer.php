<footer class="row px-4 pt-5 bg-dark d-flex justify-content-center">
    ...
    <div class="col-12 col-sm-3 mb-3">
        ...
        <ul class="nav flex-column">
            ...
            ?>
                <li class="nav-item mb-2"><a href="doctor_dashboard" class="nav-link p-0 text-light">Doctor Dashboard</a></li>
                <li class="nav-item mb-2"><a href="patient_info" class="nav-link p-0 text-light">Patient Info</a></li>
                <li class="nav-item mb-2"><a href="appointment_schedule" class="nav-link p-0 text-light">Appointment Schedule</a></li>
                <li class="nav-item mb-2"><a href="logout" class="nav-link p-0 text-light">Logout</a></li>
            <?php
            } else {
    ...
    <div class="col-12 col-sm-3 mb-3">
        ...
        <ul class="nav flex-column">
            ...
            ?>
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link p-0 text-light" href="../admin/doctor_info" aria-current="page">Doctor Info</a>
                </li>
                <li class="nav-item mb-2">
            ...
            ?>
                <li class="nav-item mb-2">
                    <a class="nav-link p-0 text-light" href="../admin/" aria-current="page">Login</a>
                </li>
            <?php
            }
            ?>
