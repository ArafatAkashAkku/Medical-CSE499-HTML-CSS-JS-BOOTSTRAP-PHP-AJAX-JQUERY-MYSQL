    ...
    ?>
        ...
        <main class="mx-4 my-3 min-height-css">
            <table id="example" class="table table-striped data-table-width">
                ...
                <tbody>
                    <?php
                    $ret = mysqli_query($con, "SELECT * FROM `appointment` WHERE `patientemail`='$_SESSION[patient_email]' AND `patientphone`='$_SESSION[patient_phone]' AND `patientname`='$_SESSION[patient_fullname]'");
                    $serial = 0;
