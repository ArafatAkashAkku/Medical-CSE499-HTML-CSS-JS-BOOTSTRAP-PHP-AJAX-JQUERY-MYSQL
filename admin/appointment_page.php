                    ...
                    ?>
                        <tr>
                            ...
                            <form action="" method="post">
                                ...
                                <td><button class="btn btn-outline-warning bg-warning text-dark px-2 py-1" type="submit" name="submit">Update</button></td>
                            </form>
                        </tr>

                        <?php
                        if (isset($_POST['submit'])) {
                            $sql = "UPDATE `appointment` SET `time`='$_POST[time]' where `id`='$id'";
                            $result = mysqli_query($con, $sql);
                            if ($result) {
                                echo "
                                <script>
                                alert('Data updated');
                                window.location.href='appointment_page.php';                               
                                </script>
                                ";
                            } else {
                                echo "
