        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if ($result_fetch['verified'] == 1) {
                if ($result_fetch['password'] == $_POST['password']) {
                    ...
                    $_SESSION['admin_fullname'] = $result_fetch['fullname'];
                    setcookie("adminemail", $result_fetch['email'], time() + (86400 * 30), "/");
                    header("location:admin_dashboard?email=$_SESSION[admin_email]&id=$_SESSION[admin_id]");
                } else {
                    echo "
                    <script>
...
<body class="overflow-x-hidden">
    ...
    <!-- main start  -->
    <main>
        <div class="d-flex flex-column align-items-center justify-content-center p-5" style="background-color: #6495ED;">
